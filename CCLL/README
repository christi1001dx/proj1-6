...
PROPOSAL:
	1. Input Page: HTML Template for text input (title, text, drop down menu for genre, submit buttom, clear button). DATE: 10/24
	   CSS + HTML
	2. Login/Registration Framework + Input Page and DB stuff in Flask + Profile Page in Flask DATE: 10/24
	3. Mongo-ify Input and Output (input = Input page, output = profile) DATE: 10/26
	4. Profile and Input page styling DATE: 10/26
`	5. Code Review
...
